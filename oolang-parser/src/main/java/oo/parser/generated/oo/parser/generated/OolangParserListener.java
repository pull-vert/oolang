...
public interface OolangParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link OolangParser#typeReference}.
	 * @param ctx the parse tree
	 */
	void enterTypeReference(OolangParser.TypeReferenceContext ctx);
	/**
	 * Exit a parse tree produced by {@link OolangParser#typeReference}.
	 * @param ctx the parse tree
	 */
	void exitTypeReference(OolangParser.TypeReferenceContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link OolangParser#typeModifiers}.
	 * @param ctx the parse tree
	 */
	void enterTypeModifiers(OolangParser.TypeModifiersContext ctx);
	/**
	 * Exit a parse tree produced by {@link OolangParser#typeModifiers}.
	 * @param ctx the parse tree
	 */
	void exitTypeModifiers(OolangParser.TypeModifiersContext ctx);
	/**
	 * Enter a parse tree produced by {@link OolangParser#typeModifier}.
	 * @param ctx the parse tree
	 */
	void enterTypeModifier(OolangParser.TypeModifierContext ctx);
	/**
	 * Exit a parse tree produced by {@link OolangParser#typeModifier}.
	 * @param ctx the parse tree
	 */
	void exitTypeModifier(OolangParser.TypeModifierContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link OolangParser#parameterModifier}.
	 * @param ctx the parse tree
	 */
	void enterParameterModifier(OolangParser.ParameterModifierContext ctx);
	/**
	 * Exit a parse tree produced by {@link OolangParser#parameterModifier}.
	 * @param ctx the parse tree
	 */
	void exitParameterModifier(OolangParser.ParameterModifierContext ctx);
	/**
